...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="Electrodomesticos.css">
...
<div class="sticky-wrapper">
    <header>
        ...
        <h1>INNOVASYS</h1>
        <a href="../../IniciarSesion/sesion.html" class="login-btn">
            <img src="../../Image/user.png" alt="Usuario"> <span><i>INICIAR SESIÓN</i></span>
        </a>
    </header>
    <nav>
    ...
    <div class="container">
        <div class="breadcrumb">
            <a href="../../index.php">Home</a> <span>ELECTRODOMESTICOS</span>
        </div>
                        ...
                        <div class="slide">
                            <div class="product-grid">
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-info">
                                        <h3>CARGADOR UNIVERSAL USB-C 65W</h3>
                                        <p class="price-info">Inicia sesión para ver precios</p>
                                        <button class="view-btn">Ver producto</button>
                                    </div>
                                </div>
